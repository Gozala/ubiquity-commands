...
CmdUtils.CreateCommand({
    ...
    description: "executes command in your os shell",
    author: { name: "Irakli Gozalishvili", email: "rfobic@gmail.com"},
    homepage: 'http://rfobic.blogspot.com/2008/10/ubiquity-command-shell.html',
    help: 'Select or type command to be executed',
